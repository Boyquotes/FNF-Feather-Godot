...
var gameplay_options:Array[GameOption] = [
	...
	GameOption.new("Note Scroll Speed", "note_speed", "Define your note speed, zero means it will use the speed from the chart.", \
		[0.0, 0.25, 0.5, 1.0, 1.25, 1.5, 2.0, 2.25, 2.5, 3.0, 3.25, 3.5, 4.0, 4.25, 4.5, 5.0]),
